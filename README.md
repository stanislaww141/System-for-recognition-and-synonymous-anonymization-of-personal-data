...
Этот проект — курсовая работа. В ноутбуке реализована система для русского языка, которая распознает персональные данные в тексте и выполняет их синонимическое обезличивание. В качестве базовой модели используется RuBERT, а для типовых идентификаторов применяются регулярные выражения. Также доступно маскирование найденных сущностей.
